...
export default function WhatsAppFloat() {
  const url = getWhatsAppUrl("Hola Shammah Bebé! Quiero consultar sobre sus productos 🌈");
  return (
    <a
      href={url}
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25d366] hover:bg-[#1ebe5d] text-white font-bold py-3 px-5 rounded-full shadow-lg transition-all hover:scale-110 group"
    ...
    >
      ...
      <span className="hidden group-hover:inline text-sm">¡Escribinos!</span>
    </a>
  );
}
