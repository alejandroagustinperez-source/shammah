  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-[#f0ecf8] overflow-hidden hover:shadow-md transition-all hover:-translate-y-1 flex flex-col">
      <div className={`relative bg-[#faf8ff] ${product.category === "muneco" ? "aspect-square" : "aspect-[3/4]"} overflow-hidden`}>
        ...
        <span className="badge-descuento absolute top-3 right-10">
          -{discount}%
        </span>
        {canShare && (
          <button
            ...
            className="absolute top-3 right-3 w-7 h-7 flex items-center justify-center rounded-full bg-white/80 backdrop-blur text-[#9b8bb4] hover:bg-white hover:text-[#7b5ea7] transition-all shadow-sm"
      ...
      {product.images.length > 1 && (
        <div className="relative py-2 px-4 bg-[#faf8ff]">
          ...
          <div ref={thumbsRef} className="flex gap-1.5 overflow-x-auto overflow-y-hidden scrollbar-hide p-1.5">
      ...
      <div className="p-4 pt-3 flex flex-col flex-1 gap-1.5">
        ...
        <div className="flex items-baseline gap-2 mt-1">
          ...
          className="flex items-center justify-center gap-2 w-full bg-[#25d366] hover:bg-[#1ebe5d] text-white font-bold py-2.5 px-4 rounded-full text-sm transition-all hover:scale-105 mt-auto"
        >
