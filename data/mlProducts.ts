import { MLProduct } from "@/components/MLProductCard";

export type { MLProduct };

export const mlCategoryLabels: Record<string, { label: string; emoji: string }> = {
  cunas: { label: "Cunas", emoji: "🛏️" },
  "silla-auto": { label: "Silla para el auto", emoji: "🚗" },
  cochecito: { label: "Cochecito de paseo", emoji: "👶" },
  paniales: { label: "Pañales", emoji: "🧷" },
  chupetes: { label: "Chupetes", emoji: "🍭" },
  biberon: { label: "Biberón", emoji: "🍼" },
  "saca-leche": { label: "Saca leche", emoji: "🤱" },
  banadera: { label: "Bañadera", emoji: "🛁" },
  jabon: { label: "Jabón", emoji: "🧴" },
  mochila: { label: "Mochila maternal", emoji: "🎒" },
  corralito: { label: "Corralito", emoji: "🛡️" },
  "silla-mecedora": { label: "Silla mecedora", emoji: "🪑" },
  oleo: { label: "Óleo calcáreo", emoji: "🧪" },
  "manta-caminadora": { label: "Manta caminadora", emoji: "🧶" },
  aspirador: { label: "Aspirador nasal", emoji: "💨" },
  "silla-comer": { label: "Silla de comer", emoji: "🍽️" },
  camara: { label: "Cámara", emoji: "📷" },
  piso: { label: "Piso encastrable", emoji: "🧩" },
};

export const mlProductsMap: Record<string, MLProduct[]> = {
  cunas: [
    {
